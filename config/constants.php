<?php
// define ('ROOT_URL', 'localhost/Shany/');
define ('ROOT_URL', '');
define ('DB_HOST', 'localhost');
define ('DB_USER', 'shany');
define ('DB_PASS', 'Admin1234');
define ('DB_NAME', 'shany');
$shany_categories = ["Bracelets", "Boucles d’oreille", "Colliers", "Autres"];
$shany_categories_description = [
    ...
    "Profitez des colliers Lunifia, il y en a pour tous les goûts, pour toutes les occasions et pour tous les budgets. Alors pourquoi s’en priver ?",
